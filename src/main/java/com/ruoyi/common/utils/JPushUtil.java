...
public class JPushUtil {
    ...
    private final static String masterSecret = "743bf5f02e58dd5116c58f68";
    private final static String appKey = "74d7a7f071d5e600df40b509";
    ...
    public static void main(String[] args){
    	...
    	pushMsg("863696037187177", "测试内容1", "", "", "测试标题1");
    }
